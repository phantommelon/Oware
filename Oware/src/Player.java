 ...
 * 
 * A default constructor with no parameters is required for each implementation of the interface. By default the input should be set to System.in and the output stream to System.out
 *
