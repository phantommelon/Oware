 ...
 *
 * See en.wikipedia.org/wiki/Oware for the layout and rules of Oware. These are summarised in community.dur.ac.uk/s.p.bradley/teaching/IP/assignment_oware/
 *
...
public interface Board
    {
        ...
        /**
         * the number of seeds in the specified house of the specified player. @see Board#makeMove for parameterDetails
         */
